...
const faqData = [
	{
		...
		answer:
			'Единственное условие — быть студентом любого вуза России. Форма обучения, курс, специальность — не имеют значения.',
	},
	{
	...
	{
		question:
			'Не хочу выполнять кейсы партнёров. У меня своя идея. Что делать?',
		answer: (
			<span>
	...
	},
	{
		...
		answer:
			'Мероприятия проходят онлайн, но последнее финальное выступление состоится очно. Город проведения сообщим позже.',
	},
	{
